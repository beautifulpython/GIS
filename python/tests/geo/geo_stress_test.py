...
#     arr = [geo for x in range(1, 1000000001)]
...
#     arr = [geo for x in range(1, 100000001)]
#     data = pandas.Series(arr)
#     rst = arctern.ST_AsText(arctern.ST_GeomFromGeoJSON(data))
#     assert len(rst) == 100000000
#
#
...
#     arr = [geo for x in range(1, 100000001)]
#     data = pandas.Series(arr)
#     rst = arctern.ST_AsText(arctern.ST_GeomFromText(data))
#     assert len(rst) == 100000000
#
#
